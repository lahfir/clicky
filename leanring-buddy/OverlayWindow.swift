    ...
    var body: some View {
        ZStack {
                ...
                Text(welcomeText)
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 6, style: .continuous)
                            .fill(DS.Colors.overlayCursorPrimary)
                            .shadow(color: DS.Colors.overlayCursorPrimary.opacity(0.5), radius: 6, x: 0, y: 0)
                    )
                    .fixedSize()
                    .overlay(
                ...
                Text(navigationBubbleText)
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 6, style: .continuous)
                            .fill(DS.Colors.overlayCursorPrimary)
                            .shadow(
                                color: DS.Colors.overlayCursorPrimary.opacity(0.5 + (1.0 - navigationBubbleScale) * 1.0),
            ...
            Triangle()
                ...
                .shadow(color: DS.Colors.overlayCursorPrimary, radius: 8 + (buddyFlightScale - 1.0) * 20, x: 0, y: 0)
...
private struct BlueCursorWaveformView: View {
    ...
    var body: some View {
        TimelineView(.animation(minimumInterval: 1.0 / 36.0)) { timelineContext in
            ...
            .shadow(color: DS.Colors.overlayCursorPrimary.opacity(0.6), radius: 6, x: 0, y: 0)
    ...
    var body: some View {
        Circle()
            ...
            .stroke(
                AngularGradient(
                    colors: [
                        DS.Colors.overlayCursorPrimary.opacity(0.0),
                        DS.Colors.overlayCursorPrimary
                    ],
                    center: .center
                ),
